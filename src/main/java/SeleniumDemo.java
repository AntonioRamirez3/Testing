...
public class SeleniumDemo {
    ...
    private static void findExceptionPageElement (WebDriver driver){

        driver.get("´{{{");
        //        //Find WebElement for the #selenium WebDriver with java for beginners program" link using link tex and partial link
        WebElement linkByTex = driver.findElement(By.linkText("Selenium WebDriver with Java for beginners program"));
        WebElement linkByPartialTex = driver.findElement(By.partialLinkText("with Java for beginners"));

        //Find WebElement for the input field using tag, class name, Xpath, and CSS
        ...
        // Cerate a list of webElements for all buttons using tag
